                                            ...
                                            <tbody class="bg-white divide-y divide-gray-100">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                        {{$emergency->firstphone}} @if ($emergency->secondphone)
                                                        {{ ', '.$emergency->secondphone }}
                                                        @endif
                                                    </td>
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                        {{ $emergency->address }}
                                                    ...
                                                    <td
                                                        ...
                                                        <a href="{{ url('emergency/'. $emergency->id . '/edit') }}"
                                                            class="px-3 ">
                                                        ...
                                                        <form action="{{ route('emergency.destroy', $emergency->id) }}"
