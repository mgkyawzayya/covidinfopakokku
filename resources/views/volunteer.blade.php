            ...
            <li class="col-span-1 bg-white rounded-lg shadow divide-y divide-gray-200">
                <div class="w-full flex items-center justify-between p-6 space-x-6">
                    <div class="flex-1 truncate">
                        ...
                        <p class="mt-1 text-gray-500 text-sm truncate break-words">{{ $volunteer->address }}</p>
                    </div>
                </div>
                <div>
                    <div class="-mt-px flex divide-x divide-gray-200">
                        <div class="w-0 flex-1 flex">
                            <a href="tel:{{ $volunteer->firstphone }}"
                                ...
                                <span class="ml-3">{{ $volunteer->firstphone }}</span>
                            </a>
                        </div>
                        @if ($volunteer->secondphone)
                        <div class="-ml-px w-0 flex-1 flex">
                            <a href="tel:{{ $volunteer->secondphone }}"
                                ...
                                <span class="ml-3">{{ $volunteer->secondphone }}</span>
                            </a>
                        </div>
                        @endif
                    </div>
