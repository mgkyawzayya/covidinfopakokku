                ...
                <div class="relative max-w-7xl mx-auto lg:grid lg:grid-cols-5">
                    <div class="bg-white py-16 px-4 sm:px-6 lg:col-span-5 lg:py-24 lg:px-8 xl:pl-12">
                        <div class="max-w-lg mx-auto lg:max-w-none">
                            <form action="{{ route('user.store') }}" method="POST" class="grid grid-cols-1 gap-y-6">
                                @csrf
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="email" name="email" id="email" autocomplete="email"
                                        ...
                                        placeholder="Email">
                                    @error('email')
                                    <p class="mt-2 text-sm text-red-600">Email required</p>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    @error('password')
                                    <p class="mt-2 text-sm text-red-600">Password required</p>
                                    @enderror
                                </div>
                                <div>
                                    <div>
